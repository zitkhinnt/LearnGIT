...
@section('title', __("horserace::be_sidebar.user_access_prediction"))
@section('content')

  <!-- breadcumb -->
@section('page_title', __("horserace::be_sidebar.user_access_prediction"))
@section('breadcrumb_item')
  <li class="breadcrumb-item">{{ __("horserace::be_sidebar.user_access_prediction") }}</li>
@endsection
  ...
  <div class="ibox">
    ...
    <div class="ibox-head">
      <div class="ibox-title">
        {{ __("horserace::be_sidebar.user_access_prediction") }}
      </div>
