...
<head>
    ...
    <link href="{{ asset('backend/vendors/line-awesome/css/line-awesome.min.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('backend/vendors/toastr/toastr.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('backend/vendors/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet" />
    <!-- PLUGINS STYLES-->
    <!-- THEME STYLES-->
...
<body>
    ...
    <div class="ibox login-content">
        <div class="text-center">
            <span class="auth-head-icon"><i class="la la-pencil-square-o"></i></span>
        </div>
    ...
    <script src="{{ asset('backend/vendors/metisMenu/dist/metisMenu.min.js') }}"></script>
    <script src="{{ asset('backend/vendors/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
    <script src="{{ asset('backend/vendors/jquery-idletimer/dist/idle-timer.min.js') }}"></script>
