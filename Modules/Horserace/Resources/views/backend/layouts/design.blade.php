...
<head>
  ...
  <!-- PLUGINS STYLES-->
  <link href="{{ asset('backend/lib/dataTables/datatables.min.css') }}" rel="stylesheet"/>
  {{--<link href="{{ asset('backend/lib/dataTable/fixedColumns.dataTables.min.css') }}" rel="stylesheet"/>--}}
  ...
  <link href="{{ asset('backend/css/custom.css') }}?{{UPDATE}}" rel="stylesheet"/>
  <!-- PAGE LEVEL STYLES-->
...
<div class="page-wrapper">
  <!-- START HEADER-->
@include('horserace::backend.layouts.header')
<!-- END HEADER-->
  <!-- START SIDEBAR-->
@include('horserace::backend.layouts.sidebar')
<!-- END SIDEBAR-->
  ...
  @yield('content')
  <!-- END PAGE CONTENT-->
    @include('horserace::backend.layouts.footer')
  </div>
</div>
...
{{--<script src="{{ asset('backend/lib/dataTable/dataTables.fixedColumns.min.js') }} "></script>--}}
<!-- CORE SCRIPTS-->
<script src="{{ asset('backend/js/app.min.js') }}"></script>
<!-- PAGE LEVEL SCRIPTS-->
<script src="{{ asset('backend/js/custom.js') }}?{{UPDATE}}"></script>
@yield('javascript')
</body>
