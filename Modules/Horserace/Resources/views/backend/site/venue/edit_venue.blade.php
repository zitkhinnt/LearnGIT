...
@section('title', __("horserace::be_sidebar.venue_edit"))
@section('content')

  <!-- breadcumb -->
  @section('page_title', __("horserace::be_sidebar.venue_edit"))
  @section('breadcrumb_item')
    <li class="breadcrumb-item">
      <a href="{{ route('admin.venue') }}"> {{ __("horserace::be_sidebar.venue") }} </a>
    </li>
    <li class="breadcrumb-item">{{ __("horserace::be_sidebar.venue_edit") }}</li>
  @endsection
    ...
    <div class="ibox">
      <div class="ibox-body">
        <h5 class="font-strong mb-4">
          {{ __("horserace::be_sidebar.venue_edit") }}
        </h5>
        <!-- Show message -->
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input class="form-control form-control-solid {{ $errors->has('name') ? ' is-invalid' : '' }}"
                       type="text" placeholder="{{ __("horserace::be_form.name") }}" name="name"
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input class="form-control form-control-solid {{ $errors->has('css') ? ' is-invalid' : '' }}"
                       type="text" placeholder="{{ __("horserace::be_form.css") }}" name="css"
                       value="{{  $data['edit']->css }}">
                @if ($errors->has('css'))
                  <span class="invalid-feedback" style="color: red; display: block">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input class="form-control form-control-solid {{ $errors->has('image') ? ' is-invalid' : '' }}"
                       type="text" placeholder="{{ __("horserace::be_form.image") }}" name="image"
                       value="{{  $data['edit']->image }}">
                @if ($errors->has('image'))
                  <span class="invalid-feedback" style="color: red; display: block">
      ...
      <div class="ibox-body">
        ...
        <div class="table-responsive row">
          <table class="table table-bordered table-hover" id="datatableBlog">
              ...
              <tr>
                ...
                <td width="50">
                  <a class="btn btn-outline-info btn-rounded"
                     href="{{ route('admin.venue.edit', $item->id) }}">
                    <span class="btn-icon">
                ...
                <td width="50">
                  <button type="button" class="btn btn-outline-danger btn-rounded"
                    ...
                    <span class="btn-icon"><i class="ti-trash"></i>
...
@section('javascript')
  <script>
    $(function () {
      ...
      var table = $('#datatableBlog').DataTable();
