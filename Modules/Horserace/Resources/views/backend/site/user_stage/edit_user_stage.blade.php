...
@section('title', __("horserace::be_sidebar.user_stage_edit"))
@section('content')

  <!-- breadcumb -->
@section('page_title', __("horserace::be_sidebar.user_stage_edit"))
@section('breadcrumb_item')
  <li class="breadcrumb-item">
    <a href="{{ route('admin.user_stage') }}"> {{ __("horserace::be_sidebar.user_stage") }} </a>
  </li>
  <li class="breadcrumb-item">{{ __("horserace::be_sidebar.user_stage_edit") }}</li>
@endsection
  ...
  <div class="ibox">
    <div class="ibox-body">
      <h5 class="font-strong mb-4">
        {{ __("horserace::be_sidebar.user_stage_edit") }}
      </h5>
      <!-- Show message -->
          ...
          <div class="col-sm-5">
            <div class="form-group">
              ...
              <input class="form-control form-control-solid {{ $errors->has('stage') ? ' is-invalid' : '' }}"
                     type="text" placeholder="{{ __("horserace::be_form.stage_description") }}" name="stage"
                     value="{{  $data['edit']->stage }}">
              @if ($errors->has('stage'))
                <span class="invalid-feedback" style="color: red; display: block">
            ...
            <tr>
              ...
              <td width="50">
                <a class="btn btn-outline-info btn-rounded"
                   href="{{ route('admin.user_stage.edit', $item->id) }}">
                    <span class="btn-icon">
