...
@section('title', __("horserace::be_sidebar.point_edit"))
@section('content')

  <!-- breadcumb -->
  @section('page_title', __("horserace::be_sidebar.point_edit"))
  @section('breadcrumb_item')
    <li class="breadcrumb-item">
      <a href="{{ route('admin.point') }}"> {{ __("horserace::be_sidebar.point") }} </a>
    </li>
    <li class="breadcrumb-item">{{ __("horserace::be_sidebar.point_edit") }}</li>
  @endsection
    ...
    <div class="ibox">
      <div class="ibox-body">
        <h5 class="font-strong mb-4">
          {{ __("horserace::be_sidebar.point_edit") }}
        </h5>
        <!-- Show message -->
        ...
        <form class="form-category" action="{{ route('admin.point.store') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-sm-5">
              <div class="form-group">
                ...
                <input class="form-control form-control-solid {{ $errors->has('point') ? ' is-invalid' : '' }}"
                       type="text"
                       placeholder="{{ __("horserace::be_form.point") }}" name="point"
                       value="{{  $data['edit']->point }}">
                @if ($errors->has('point'))
            ...
            <div class="col-sm-5">
              <div class="form-group">
                ...
                <input class="form-control form-control-solid {{ $errors->has('price') ? ' is-invalid' : '' }}"
                       type="text" placeholder="{{ __("horserace::be_form.price") }}" name="price"
                       value="{{  $data['edit']->price }}">
                @if ($errors->has('price'))
                  <span class="invalid-feedback" style="color: red; display: block">
            ...
            <div class="col-sm-2" style="margin: auto">
              <button class="mb-0 ml-2 btn btn-success" type="submit">
      ...
      <div class="ibox-body">
        <div class="flexbox mb-4">
          <div class="flexbox">
            <h5 class="font-strong mb-4"> {{ __("horserace::be_sidebar.point_list") }} </h5>
          </div>
