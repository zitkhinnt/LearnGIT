...
@section('title', __("horserace::be_sidebar.blog_add"))
@section('content')
...
@section('breadcrumb_item')
  ...
  <li class="breadcrumb-item">{{ __("horserace::be_sidebar.blog_add") }}</li>
@endsection
  ...
  <div class="ibox">
    <div class="ibox-head">
      <div class="ibox-title">
        {{ __("horserace::be_sidebar.blog_add") }}
      </div>
      <div class="">
      </div>
    </div>
      ...
      <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 form-group">
              ...
              <div class="input-group datetime">
                ...
                <input class="form-control {{ $errors->has('public_at') ? ' is-invalid' : '' }}"
                      type="text" value="{{ old('public_at') }}" name="public_at">
              </div>
          ...
          <div class="col-lg-3">
            ...
            <div class="input-group datetime">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input type="text" class="form-control {{ $errors->has('public_end') ? 'is-invalid' : '' }}" value="{{ old('public_end') }}" name="public_end">
            </div>
