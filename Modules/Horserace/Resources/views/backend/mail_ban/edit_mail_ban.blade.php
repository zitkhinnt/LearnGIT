...
@section('title', __("horserace::be_sidebar.mail_ban_edit"))
@section('content')

  <!-- breadcumb -->
@section('page_title', __("horserace::be_sidebar.mail_ban_edit"))
@section('breadcrumb_item')
  <li class="breadcrumb-item">
    <a href="{{ route('admin.mail_ban') }}"> {{ __("horserace::be_sidebar.mail_ban") }} </a>
  </li>
  <li class="breadcrumb-item">{{ __("horserace::be_sidebar.mail_ban_edit") }}</li>
@endsection
  ...
  <div class="ibox">
    <div class="ibox-body">
      <h5 class="font-strong mb-4">
        {{ __("horserace::be_sidebar.mail_ban_edit") }}
      </h5>
      <!-- Show message -->
          ...
          <div class="col-sm-5">
            <div class="form-group">
              ...
              <input class="form-control form-control-solid {{ $errors->has('mail') ? ' is-invalid' : '' }}"
                     type="text" placeholder="{{ __("horserace::be_form.mail_ban") }}" name="mail"
                     value="{{  $data['edit']->mail }}">
              @if ($errors->has('mail'))
            ...
            <tr>
              ...
              <td width="50">
                <a class="btn btn-outline-info btn-rounded"
                   href="{{ route('admin.mail_ban.edit', $item->id) }}">
                    <span class="btn-icon">
