<!-- Modal Delete Post  -->
<div class="modal fade" id="reviewCondition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <input class="form-control login_id" type="text" name="login_id" value="" readonly>
          </div>
          <!-- user key -->
          <div class="col-md-3 mb-3">
            <label>{{ __("horserace::be_form.user_key") }}</label>
            <input class="form-control user_key" name="user_key" type="text" value="" readonly>
          </div>
          <!-- point min -->
          <div class="col-md-3 mb-3 ">
            <label>{{ __("horserace::be_form.point_min") }}</label>
            <input class="form-control point_min" type="number" name="point_min" value="" readonly>
          </div>
          <!-- point max-->
          <div class="col-md-3 mb-3 ">
            <label>{{ __("horserace::be_form.point_max") }}</label>
            <input class="form-control point_max" type="number" name="point_max" value="" readonly>
          </div>
        </div>
        <div class="row">
          <!-- nick  name -->
          <div class="col-md-3 mb-3">
            ...
            <input class="form-control nickname" type="text" name="nickname" value="" readonly>
          </div>
          ...
          <div class="col-md-3 mb-3">
            ...
            <input class="form-control deposit_total_amount_min" type="number" name="deposit_total_amount_min" readonly
                   value="">
          </div>
          <!--deposit_total_amount max-->
          <div class="col-md-3 mb-3">
            <label>{{ __("horserace::be_form.deposit_total_amount_max") }}</label>
            <input class="form-control deposit_total_amount_max" type="number" name="deposit_total_amount_max" readonly
                   value="">
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <select class="show-tick form-control age" name="age" disabled>
              <option value="{{ null }}">
                {{ __("horserace::be_form.unset") }}
              </option>
          ...
          <div class=" col-md-3 mb-3">
            ...
            <input class="form-control deposit_total_number_min" type="number" name="deposit_total_number_min" readonly
                   value="">
          </div>
          <!-- deposit_total_number max -->
          <div class="col-md-3 mb-3">
            <label>{{ __("horserace::be_form.deposit_total_number_max") }}</label>
            <input class="form-control deposit_total_number_max" type="number" name="deposit_total_number_max"
                   readonly=""
                   value="">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <input class="form-control mail_pc" type="text" name="mail_pc" value="" readonly>
          </div>
          <!-- mail mobile-->
          <div class="col-md-3 mb-3">
            <label>{{ __("horserace::be_form.mail_mobile") }}</label>
            <input class="form-control mail_mobile" type="text" name="mail_mobile" value="" readonly>
          </div>
          <!-- login_number min -->
          <div class="col-md-3 mb-3">
            <label> {{ __("horserace::be_form.login_number_min") }}</label>
            <input class="form-control login_number_min" type="number" name="login_number_min" value="" readonly>
          </div>
          <!-- login_number max -->
          <div class="col-md-3 mb-3">
            <label>{{ __("horserace::be_form.login_number_max") }}</label>
            <input class="form-control login_number_max" type="number" name="login_number_max" value="" readonly>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <input class="form-control ip" type="text" name="ip" value="" readonly>
          </div>
          <!-- Prediction type -->
          <div class="col-md-3 mb-3">
            <label>{{ __("horserace::be_form.prediction_type") }}</label>
            <select class="show-tick form-control prediction_type" name="prediction_type" disabled>
              <option value="{{ null }}">
                {{ __("horserace::be_form.unset") }}
              </option>
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              ...
              <input class="form-control register_time_start" type="text" name="register_time_start"
                     value="" readonly>
            </div>
          </div>
          <!-- register_time end -->
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control register_time_end" type="text" name="register_time_end" value="" readonly>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <select class="show-tick form-control media_code" name="media_code" disabled>
              <option value="{{ null }}">
                {{ __("horserace::be_form.unset") }}
              </option>
          ...
          <div class="col-md-3 mb-3">
            ...
            <select class="show-tick form-control entrance_id" name="entrance_id" disabled>
              <option value="{{ null }}">
                {{ __("horserace::be_form.unset") }}
              </option>
          ...
          <div class="col-md-3 mb-3">
            ...
            <select class="show-tick form-control stop_mail" name="stop_mail" disabled>
              <option value="{{ null }}">
                {{ __("horserace::be_form.unset") }}
              </option>
          ...
          <div class="col-md-3 mb-3">
            ...
            <select class="show-tick form-control sns_register" name="sns_register" disabled>
              <option value="">
                {{ __("horserace::be_form.unset") }}
              </option>
          ...
          <div class="col-md-6 mb-6">
            ...
            <label style="margin-left:20px"><input type="radio" name="option_summer" value="1" disabled> 完全一致</label>
            <label style="margin-left:20px"><input type="radio" name="option_summer" value="0" checked disabled> 部分一致</label>
            
            <input class="form-control" type="text" name="summernote" value="{{  old("summernote") }}" readonly>
        </div>
          ...
          <div class="col-md-6 mb-6">
            ...
            <label style="margin-left:20px"><input type="radio" name="option_summer_not" value="1" disabled> 完全一致</label>
            <label style="margin-left:20px"><input type="radio" name="option_summer_not" value="0" checked disabled> 部分一致</label>
            <input class="form-control" type="text" name="summernote_not" value="{{  old("summernote_not") }}" readonly>
          </div>
        </div>
        ...
        <div class="row" style="margin-top:15px">
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control first_deposit_time_start" type="text" name="first_deposit_time_start"
                     value="" readonly>
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control first_deposit_time_end" type="text" name="first_deposit_time_end"
                     value="" readonly>
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control last_deposit_time_start" type="text" name="last_deposit_time_start"
                     value="" readonly>
            </div>
          </div>
          <!-- last_deposit_time-->
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control last_deposit_time_end" type="text" name="last_deposit_time_end"
                     value="" readonly>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control first_payment_time_start" type="text" name="first_payment_time_start"
                     value="" readonly>
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control first_payment_time_end" type="text" name="first_payment_time_end"
                     value="" readonly>
            </div>
          </div>
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control last_payment_time_start" type="text" name="last_payment_time_start"
                     value="" readonly>
            </div>
          </div>
          <!-- last_payment_time-->
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control last_payment_time_end" type="text" name="last_payment_time_end"
                     value="" readonly>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control last_login_time_start" type="text" name="last_login_time_start"
                     value="" readonly>
            </div>
          </div>
          <!-- last_login_time end-->
          <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control last_login_time_end" type="text" name="last_login_time_end"
                     value="" readonly>
            </div>
          </div>
          ...
          {{-- <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control last_access_time_start" type="text" name="last_access_time_start"
                     value="" readonly>
            </div>
          </div> --}}
          ...
          {{-- <div class="col-md-3 mb-3">
            ...
            <div class="input-group date" data-provide="datepicker">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              <input class="form-control last_access_time_end" type="text" name="last_access_time_end"
                     value="" readonly>
            </div>
          </div> --}}
        </div>
        ...
        <div class="row">
          ...
          <select class="selectpicker show-tick form-control ml-3 mb-3 col-md-2" name="search_match_type" id="search_match_type" disabled>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" readonly>
