<!-- Modal Delete Post  -->
<div class="modal fade" id="addGiftAll" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form method="POST" action="{{ route("admin.gift_all.add") }}">
          {{ csrf_field() }}
          <input type="hidden" name="type" value="{{ TRANSACTION_GIFT_TYPE_BONUS }}">
          <input type="hidden" id="add-condition" name="condition" value="">
          <div class="row">
