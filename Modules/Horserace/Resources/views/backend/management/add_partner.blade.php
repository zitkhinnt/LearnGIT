...
@section('title', __("horserace::be_sidebar.partner_add"))
@section('content')
...
@section('breadcrumb_item')
  ...
  <li class="breadcrumb-item">{{ __("horserace::be_sidebar.partner_add") }}</li>
@endsection
    ...
    <form action="{{ route('admin.partner.store') }}" method="POST">
      ...
      <div class="ibox-head">
        <div class="ibox-title">
          {{ __("horserace::be_sidebar.partner_add") }}
        </div>
      </div>
      <div class="ibox-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group mb-4">
              ...
              <input class="form-control {{ $errors->has('media_code') ? ' is-invalid' : '' }}"
                     type="text" name="media_code" value="{{ old("media_code") }}">
            ...
            <div class="form-group mb-4">
              <label class="checkbox">
                <input class="form-control" type="checkbox" name="billing_flg" value="{{ BILLING_FLG_ENABLE }}">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group mb-4">
              ...
              <input class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}"
                     type="text" name="password" value="{{ old("password") }}">
