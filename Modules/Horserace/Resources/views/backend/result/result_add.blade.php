...
@section('breadcrumb_item')
  ...
  <li class="breadcrumb-item">{{ __("horserace::be_sidebar.result_add") }}</li>
@endsection
  ...
  <div class="ibox">
    <div class="ibox-head">
      <div class="ibox-title">
        {{ __("horserace::be_sidebar.result_add") }}
      </div>
      <div class="">
      </div>
    </div>
            ...
            <div class="row">
              ...
              {{--<div class="col-sm-3 form-group">
                ...
                <input class="form-control {{ $errors->has('course_text') ? ' is-invalid' : '' }}"
                       type="text" name="course_text" value="{{ old("course_text") }}"
              ...
              <div class="col-sm-3 form-group">
                  ...
                  <select
                    class="selectpicker form-control {{ $errors->has('prediction_type') ? ' is-invalid' : '' }}"
                    name="course">
                    <option value="">
              ...
              <div class="col-lg-3">
                <div class="col-sm-12 form-group">
                  ...
                  <select class="selectpicker show-tick form-control" name="double" id="double"
                          onchange="resultReadOnly();">
                    <option value="{{ DOUBLE_ON }}"
                      {{ !is_null(old('double')) && old('double') == DOUBLE_ON ? "selected" : ""}} >
                      {{ __("horserace::be_form.double_on") }}
                    </option>
                    <option value="{{ DOUBLE_OFF }}" selected
                      {{ !is_null(old('double')) && old('double') == DOUBLE_OFF ? "selected" : ""}} >
              ...
              <div class="col-sm-3 form-group">
                ...
                <div class="input-group date">
                  ...
                  <input class="form-control {{ $errors->has('date') ? ' is-invalid' : '' }}"
                         type="text" value="{{ old('date') }}" name="date">
                </div>
                @if ($errors->has('date'))
                  <span class="invalid-feedback" style="color: red; display: block">
    <strong>{{ $errors->first('date') }}</strong>
              ...
              <div class="col-sm-3 form-group">
                ...
                <input class="form-control {{ $errors->has('korogashi') ? ' is-invalid' : '' }}"
                       type="text" name="korogashi" value="{{ old("korogashi") }}"
    ...
    <strong>{{ $errors->first('korogashi') }}</strong>
            ...
            <div class="row">
              ...
              <div class="col-sm-3 form-group" style="display:none;">
                ...
                <input class="form-control {{ $errors->has('race_no_1_title') ? ' is-invalid' : '' }}"
                       type="text" name="race_no_1_title" value="{{ old("race_no_1_title") }}"
      ...
      <strong>{{ $errors->first('race_no_1_title') }}</strong>
              ...
              <!-- race_no_1 -->
              <div class="col-sm-3 form-group">{{--class="col-lg-3">--}}
                <div class="col-sm-12 form-group">
                  ...
                  <select
                    ...
                    <option value="{{ RACE_NO_1 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_1 ? "selected" : ""}} >
                      {{ __("horserace::be_form.race_no_1") }}
                    </option>
                    <option value="{{ RACE_NO_2 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_2 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_2") }}
                    </option>
                    <option value="{{ RACE_NO_3 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_3 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_3") }}
                    </option>
                    <option value="{{ RACE_NO_4 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_4 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_4") }}
                    </option>
                    <option value="{{ RACE_NO_5 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_5 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_5")  }}
                    </option>
                    <option value="{{ RACE_NO_6 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_6 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_6")  }}
                    </option>
                    <option value="{{ RACE_NO_7 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_7 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_7")  }}
                    </option>
                    <option value="{{ RACE_NO_8 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_8 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_8")  }}
                    </option>
                    <option value="{{ RACE_NO_9 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_9 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_9")  }}
                    </option>
                    <option value="{{ RACE_NO_10 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_10 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_10")  }}
                    </option>
                    <option value="{{ RACE_NO_11 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_11 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_11")  }}
                    </option>
                    <option value="{{ RACE_NO_12 }}"
                      {{ !is_null(old('race_no_1_num')) && old('race_no_1_num') == RACE_NO_12? "selected" : ""}} >
              ...
              <div class="col-sm-3 form-group">{{--class="col-lg-3">--}}
                <div class="col-sm-12 form-group">
                  ...
                  <select
                    ...
                    <option value="{{ RACE_NO_1 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_1 ? "selected" : ""}} >
                      {{ __("horserace::be_form.race_no_1") }}
                    </option>
                    <option value="{{ RACE_NO_2 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_2 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_2") }}
                    </option>
                    <option value="{{ RACE_NO_3 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_3 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_3") }}
                    </option>
                    <option value="{{ RACE_NO_4 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_4 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_4") }}
                    </option>
                    <option value="{{ RACE_NO_5 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_5 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_5")  }}
                    </option>
                    <option value="{{ RACE_NO_6 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_6 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_6")  }}
                    </option>
                    <option value="{{ RACE_NO_7 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_7 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_7")  }}
                    </option>
                    <option value="{{ RACE_NO_8 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_8 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_8")  }}
                    </option>
                    <option value="{{ RACE_NO_9 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_9 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_9")  }}
                    </option>
                    <option value="{{ RACE_NO_10 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_10 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_10")  }}
                    </option>
                    <option value="{{ RACE_NO_11 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_11 ? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_11")  }}
                    </option>
                    <option value="{{ RACE_NO_12 }}"
                      {{ !is_null(old('race_no_2_num')) && old('race_no_2_num') == RACE_NO_12? "selected" : ""}} >
                      {{  __("horserace::be_form.race_no_12")  }}
                    </option>
                  </select>
            ...
            <div class="row">
              ...
              <div class="col-sm-3 form-group" style="display:none;">
                ...
                <input class="form-control {{ $errors->has('race_no_2_title') ? ' is-invalid' : '' }}"
                       type="text" name="race_no_2_title" id="race_no_2_title" value="{{ old("race_no_2_title") }}"
              ...
              <div class="col-sm-3 form-group">
                ...
                <select
                  ...
                  <option value="{{ TICKET_TYPE_1 }}"
                    {{ !is_null(old('ticket_type')) && old('ticket_type') == TICKET_TYPE_1 ? "selected" : ""}} >
                    {{ __("horserace::be_form.ticket_type_1") }}
                  </option>
                  <option value="{{ TICKET_TYPE_2 }}"
                    {{ !is_null(old('ticket_type')) && old('ticket_type') == TICKET_TYPE_2 ? "selected" : ""}} >
                    {{  __("horserace::be_form.ticket_type_2") }}
                  </option>
                  <option value="{{ TICKET_TYPE_3 }}"
                    {{ !is_null(old('ticket_type')) && old('ticket_type') == TICKET_TYPE_3 ? "selected" : ""}} >
              ...
              <div class="col-lg-3 mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2 pr-0 pl-0">
                    <input name="bike_number_1" class="form-control pr-0" type="number" min="0" value="0">
                  </div>
                  <label class="col-form-label pr-0 ml-2">2着</label>
                  <div class="col-sm-2 pr-0 pl-0">
                    <input name="bike_number_2" class="form-control pr-0" type="number" min="0" value="0">
                  </div>
                  <label class="col-form-label pr-0 ml-2">3着</label>
                  <div class="col-sm-2 pr-0 pl-0">
                    <input name="bike_number_3" class="form-control pr-0" type="number" min="0" value="0">
                  </div>
                </div>
              </div> 
              
                <!-- bike_number 2 -->
              <div class="col-lg-3 mb-3" id='bike_number_2'>
                <label>{{ __("horserace::be_form.bike_number") }} 2</label>
                <div class="row">
                  <label class="col-form-label pr-0 ml-2">1着</label>
                  <div class="col-sm-2 pr-0 pl-0">
                    <input id='bike_number_1_2' name="bike_number_1_2" class="form-control pr-0" type="number" min="0" value="0">
                  </div>
                  <label class="col-form-label pr-0 ml-2">2着</label>
                  <div class="col-sm-2 pr-0 pl-0">
                    <input id='bike_number_2_2' name="bike_number_2_2" class="form-control pr-0" type="number" min="0" value="0">
                  </div>
                  <label class="col-form-label pr-0 ml-2">3着</label>
                  <div class="col-sm-2 pr-0 pl-0">
                    <input id='bike_number_3_2' name="bike_number_3_2" class="form-control pr-0" type="number" min="0" value="0">
                  </div>
                </div>
              </div> 
              ...
              <div class="col-sm-3 mb-3">
                ...
                <div class="row">
                  <div class="col-sm-3 pr-0 pl-0">
                    <input name="won_man" class="form-control pr-0" type="number" min="0" value="0">
                  </div>
                  <label class="col-form-label ml-2 pr-0">万</label>

                  <div class="col-sm-3 pr-0 pl-0  ml-3">
                    <input name="won_yen" class="form-control pr-0" type="number" min="0" value="0">
                  </div>
