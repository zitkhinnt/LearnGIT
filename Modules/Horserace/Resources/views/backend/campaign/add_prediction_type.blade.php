...
@section('title', __("horserace::be_sidebar.prediction_type_add"))
@section('content')
  <!-- breadcumb -->
...
@section('breadcrumb_item')
  ...
  <li class="breadcrumb-item">{{ __("horserace::be_sidebar.prediction_type_add") }}</li>
@endsection
<!-- START PAGE CONTENT-->
<div class="page-content fade-in-up">
  <div class="ibox">
    <form action="{{ route("admin.prediction_type.store") }}" method="POST"
          enctype="multipart/form-data">
      @csrf
      <input type="hidden" name="id" value="0">
      <div class="ibox-head">
        <div class="ibox-title">
          {{ __("horserace::be_sidebar.prediction_type_add") }}
        </div>
      </div>
