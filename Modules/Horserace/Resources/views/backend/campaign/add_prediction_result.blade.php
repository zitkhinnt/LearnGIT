  ...
  <div class="page-content fade-in-up">
    <div class="ibox">
      <form action="{{ route("admin.prediction_result.store") }}" method="POST"
        ...
        <input type="hidden" name="prediction_id" value="{{ $data["id_prediction"] }}">
        <div class="ibox-head">
          <div class="ibox-title">
            {{ __("horserace::be_sidebar.add_prediction_result") }}
          </div>
        </div>
            ...
            <div class="col-sm-3 form-group mb-3">
              ...
              <div class="input-group date" data-provide="datepicker">
                ...
                <input class="form-control {{ $errors->has('race_date') ? ' is-invalid' : '' }}"
                       type="text" name="race_date" value="{{ old("race_date") }}">
              </div>
